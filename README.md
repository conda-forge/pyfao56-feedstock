...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyfao56-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15207&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyfao56-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyfao56` can be installed with:

```
conda install pyfao56
```

It is possible to list all of the versions of `pyfao56` available on your platform with:
